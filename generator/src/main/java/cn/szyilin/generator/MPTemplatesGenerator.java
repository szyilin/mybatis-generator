 ...
 * @author szyilin
 */
public class MPTemplatesGenerator {
    public static void main(String[] args) {
        // 数据库配置
        // 注意修改数据库名
        String url = "jdbc:mysql://localhost:3306/programming?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";
        ...
        String parent = "cn.szyilin.programming_community"; // 父包名
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .templateConfig(config -> config
                        .controller("/templates/mybatis-puls/controller.java")
                        .entity("/templates/mybatis-puls/entity.java")
                        .mapper("/templates/mybatis-puls/mapper.java")
                        .service("/templates/mybatis-puls/service.java")
                        .serviceImpl("/templates/mybatis-puls/serviceImpl.java")
                )
                .execute(); // 执行
    }
